...
./vaccination.exe -h 
        ...
        -e NCOMP splits the E/P1/P2 compartments (default 1) in NCOMP compartments preserving global rate
		-v NCOMP splits of the vS_LOW/vS_MID compartments (default 1) in NCOMP compartments preserving global rate
